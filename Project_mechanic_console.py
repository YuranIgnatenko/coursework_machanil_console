...
print('ПРИВЕТСТВУЮ!')
print('ЭТА НЕ БОЛЬШАЯ ПРОГРАММА ПОЗВОЛИТ СПРАВИТЬСЯ ТЕБЕ С КУРСОВЫМ ПРОЕКТОМ ПО МЕХАНИЗАЦИИ И ТО')
print()
print()
...
##if count != 0:
##    def f(count):
##        print("КЛЮЧ БЫЛ ", count," РАЗ(А) НЕ ВЕРНО ВВЕДЕН!")
##
...
print ()
print (("_") * 75)
print ("ВВЕДИТЕ КОЛИЧЕСТВО ТРАКТОРОВ:")
print (("_") * 75)
print ()
# К-700

#__________________________________________________________________________________________________________
# ЦИКЛ НА ЗАПРОС И ПРОВЕРКУ ЗНАЧЕНИЯ: КОЛ-ВО К-700
while True:
    K_700 = input ("K_700:  ")
    if K_700.isdigit():
        K_700 = int(K_700)
...
#   ТРАКТОР: K-701
#__________________________________________________________________________________________________________
# ЦИКЛ НА ЗАПРОС И ПРОВЕРКУ ЗНАЧЕНИЯ: КОЛ-ВО
while True:
    K_701 = input ("K_701:  ")
    if K_701.isdigit():
        K_701 = int(K_701)
